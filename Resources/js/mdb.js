...
function upTo(t, e) {
    ...
    var n = i.helpers = {},
        ...
        _ = n.getMaximumWidth = function(t) {
            var e = t.parentNode,
                i = parseInt(H(e, "padding-left")) + parseInt(H(e, "padding-right"));
            return e.clientWidth - i
        },
        $ = n.getMaximumHeight = function(t) {
            var e = t.parentNode,
                i = parseInt(H(e, "padding-bottom")) + parseInt(H(e, "padding-top"));
            return e.clientHeight - i
        },
        H = n.getStyle = function(t, e) {
    ...
    function() {
    ...
    }.call(this), $(".smooth-scroll").on("click", "a", function(t) {
        t.preventDefault();
        ...
        function W() {
            this.evEl = _t, this.evWin = $t, this.allow = !0, this.pressed = !1, S.apply(this, arguments)
        }
        ...
        function C(e, n) {
            ...
            if (this.id = p("cp"), this.element = e, this.holder = u, this.options = n, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = P, this.input = T, this.label = A, this.popover = a, this.plate = o, this.hoursView = f, this.minutesView = C, this.amPmBlock = S, this.spanHours = a.find(".clockpicker-span-hours"), this.spanMinutes = a.find(".clockpicker-span-minutes"), this.spanAmPm = a.find(".clockpicker-span-am-pm"), this.footer = a.find(".picker__footer"), this.amOrPm = "PM", n.twelvehour) {
                ...
                n.ampmclickable ? (this.spanAmPm.empty(), t('<div id="click-am">AM</div>').on("click", function() {
                    ...
                    M.amOrPm = "PM", M.amPmBlock.children(".am-button").removeClass("active"),
                        M.amPmBlock.children(".pm-button").addClass("active"), M.spanAmPm.empty().append("PM")
            ...
            if (o.on(r, function(e) {
                ...
                var _ = a.find(".clockpicker-canvas"),
                    $ = h("svg");
                $.setAttribute("class", "clockpicker-svg"), $.setAttribute("width", b), $.setAttribute("height", b);
                var H = h("g");
                ...
                var q = h("circle");
                q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), H.appendChild(j), H.appendChild(N), H.appendChild(q), H.appendChild(B), $.appendChild(H), _.append($), this.hand = j, this.bg = N, this.fg = q, this.bearing = B, this.g = H, this.canvas = _
            }
            k(this.options.init)
        }
    ...
    function(t) {
        t(document).ready(function() {
            ...
            t(n).each(function() {
                ...
                for (var e = t(this).closest(".file-field"), i = e.find("input.file-path"), n = t(this)[0].files, s = [], a = 0; a < n.length; a++) s.push(n[a].name);
                    ...
                    function t(t) {
                        ...
                        if ("scroll" === M) {
                            ...
                            for (var D in y) {
                                ...
                                var H = x.Hooks.getRoot(D),
                                    B = !1;
                                if (o(s).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== n) {
                                    (a.display !== n && null !== a.display && "none" !== a.display || a.visibility !== n && "hidden" !== a.visibility) && /opacity|filter/.test(D) && !$ && 0 !== W && ($ = 0), a._cacheValues && L && L[D] ? ($ === n && ($ = L[D].endValue + L[D].unitType), B = o(s).rootPropertyValueCache[H]) : x.Hooks.registered[D] ? $ === n ? (B = x.getPropertyValue(s, H), $ = x.getPropertyValue(s, D, B)) : B = x.Hooks.templates[H][1] : $ === n && ($ = x.getPropertyValue(s, D));
                                    var j, N, q, X = !1;
                                    if (j = d(D, $), $ = j[0], q = j[1], j = d(D, W), W = j[0].replace(/^([+-\/*])=/, function(t, e) {
                                            return X = e, ""
                                        }), N = j[1], $ = parseFloat($) || 0, W = parseFloat(W) || 0, "%" === N && (/^(fontSize|lineHeight)$/.test(D) ? (W /= 100, N = "em") : /^scale/.test(D) ? (W /= 100, N = "") : /(Red|Green|Blue)$/i.test(D) && (W = W / 100 * 255, N = "")), /[\/*]/.test(X)) N = q;
                                    else if (q !== N && 0 !== $)
                                        if (0 === W) N = q;
                                        else {
                                            l = l || f();
                                            ...
                                            switch (q) {
                                                case "%":
                                                    $ *= "x" === Y ? l.percentToPxWidth : l.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                            ...
                                            switch (N) {
                                                case "%":
                                                    $ *= 1 / ("x" === Y ? l.percentToPxWidth : l.percentToPxHeight);
                                                    break;
                                                case "px":
                                                    break;
                                                default:
